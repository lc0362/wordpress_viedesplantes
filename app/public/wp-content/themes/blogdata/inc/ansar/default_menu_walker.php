<?php 
function blogdata_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'blogdata_page_menu_args' );
function blogdata_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new blogdata_walker_page_menu;
...
class blogdata_walker_page_menu extends Walker_Page{
