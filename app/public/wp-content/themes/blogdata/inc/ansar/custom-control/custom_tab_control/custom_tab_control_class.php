...
class Custom_Tab_Control extends WP_Customize_Control {
	...
	<div class="control-tabs">
		<div class="control-tab control-tab-general active" data-connected="<?php echo esc_attr( $this->controls_general ); ?>"><?php echo esc_html__( 'General','blogdata' ); ?>
		</div>
		<div class="control-tab control-tab-design" data-connected="<?php echo esc_attr( $this->controls_design ); ?>"><?php echo esc_html__( 'Style','blogdata'); ?>
		</div>
		<div class="control-tab control-tab-custom" data-connected="<?php echo esc_attr( $this->controls_custom ); ?>"><?php echo esc_html__( 'Sharing Social Icon','blogdata'); ?>
		</div>
	</div>
	<?php
	}
