...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () { 
        ...
        if(jQuery("#blogdata_social_limit").val()==5)
        {
           jQuery(".customizer_blogdata_social_upgrade_to").show();
            return false;
        }
        else
        {
           var total_social_sections=parseInt(jQuery("#blogdata_social_limit").val())+1;
           jQuery("#blogdata_social_limit").val(total_social_sections)
           if(jQuery("#blogdata_social_limit").val()>5)
            {
                jQuery(".customizer_blogdata_social_upgrade_to").hide();
            }
        }
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        var total_icon= parseInt(jQuery("#blogdata_social_limit").val())-1;
       jQuery("#blogdata_social_limit").val(total_icon);
